...
To verify the proposed algorithm, we compared with EM for mixture of Gaussians and spectral algorithm for mixture of spherical Gaussians~\citep{Hsu13}. We also compared with the spectral algorithms based on histgram in~\citep{Hiroyuki10}. However, their performance is not comparable to others, so that we didn't plot it in the figures. \texttt{Add details of the results.}
