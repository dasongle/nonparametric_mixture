...
%{Again for simplicity of exposition, the algorithm is explained for symmetric view case. The more general version is presented in Appendix~\ref{sec:symmetrization}.}
...
\begin{figure}[t]
  ...
  {  \includegraphics[width=0.475\columnwidth]{../experiment/visualization/em_visual_k_2_view_1-crop}
  }
  \subfigure[Kernel Spectral]
  {
  \includegraphics[width=0.475\columnwidth]{../experiment/visualization/visual_k_2_view_1-crop-crop}
  }
  \vspace{-3mm}
