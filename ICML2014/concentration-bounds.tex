...
%
%Let $\rho:=\sup_{x \in \Omega} k(x,x)$,   $\| \cdot\|_{}$ be the Hilbert-Schmidt norm, $r_{\min}:=\min_{i\in [k]} \pi_i$ and $\sigma_k(\Ccal_{X_1, X_2})$ be the $k$-th singular value of $\Ccal_{X_1, X_2}$.
%
...
\leq \frac{2\sqrt{2}\epsilon_{triples}}{\sigma_k(\Ccal_{X_1 X_2})^{1.5} }+\frac{\epsilon_W^3}{\sqrt{r_{\min}}}\iffalse+ \|E_{X_1 X_2 X_3}\| \frac{\epsilon_W^3}{r_{\min}^{1.5} \sigma_k(M)^3} \fi.\eeq
\end{lemma}
