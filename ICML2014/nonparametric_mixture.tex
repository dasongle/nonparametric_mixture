...
\noindent {\bf Relation between kernel embedding and the density function.} Basically kernel embeddings maps the density to a function in the RKHS. See Steinwardt and Vert \textcolor{red}{(need to say more)}.
...
\tilde{\mathcal{C}}_{X_3 X_1} &=& \widehat{\mathcal{C}}_{X_3X_1}\Phi_k = \frac{1}{m}\Upsilon{K}_{nk}\\
\tilde{\mathcal{C}}_{X_3 X_2} &=& \widehat{\mathcal{C}}_{X_3X_2}\Psi_k = \frac{1}{m}\Upsilon{L}_{nk}\\
\tilde{\mathcal{C}}_{X_1 X_2 X_3} &=&
\widehat{\mathcal{C}}_{X_1 X_2 X_3}\times_1\Phi_k^\top
...
Assume the leading $k$ eigenvectors $\nu_k$ lie in the span of the column of $\Phi$, i.e., $\nu_k = \Upsilon \beta_k$ where $\beta_k\in \mathbb{R}^{m\times 1}$\bxcomment{in the span of the columns of $\Upsilon$?}
%
\begin{eqnarray*}
...
%
\begin{eqnarray*}
\widehat{\mathcal{T}} &=& Triple_3 \times_1 \widehat{S}_k^{-\frac{1}{2}}\beta^\top\Upsilon^\top \times_2
\widehat{S}_k^{-\frac{1}{2}}\beta^\top\Upsilon^\top \times_3 \widehat{S}_k^{-\frac{1}{2}}\beta^\top\Upsilon^\top\\
