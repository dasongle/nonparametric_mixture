...
\bodai{One reviewer concerns about computational complexity and claims that the algorithm should be written in terms of kernel matrix. Or at least, we need to specify the size of the gram matrix and tensor. }
...
$$
\bodai{I think the $\diag{\lambda}$ should be removed. It is used for recovering ratio.}
\vspace{-3mm}
