...
Last we will experimentally compare our kernel algorithm to EM algorithm and previous spectral algorithms. We show that when the model assumptions are correct for EM and previous spectral algorithms, our algorithm converges in terms of estimation error to these competitors. In the opposite cases when the model assumptions are incorrect, our algorithm is able to adaptive to the nonparametric mixture components and beating alternatives by a very large margin.
