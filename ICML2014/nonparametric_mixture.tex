...
\begin{align*}
  p_j(x_1,x_2) &= (2\pi)^{-1} \sigma^{-2} \exp\rbr{-\frac{1}{2\sigma^2} \sum_{i=1}^2 (x_i - j\delta)^2} \\
  p_j(x_1,x_2,x_3) &= (2\pi)^{-3/2} \sigma^{-3} \exp\rbr{-\frac{1}{2\sigma^2} \sum_{i=1}^3 (x_i - j\delta)^2}
\end{align*}
